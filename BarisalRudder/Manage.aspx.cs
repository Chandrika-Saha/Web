...
public partial class Manage : System.Web.UI.Page
{
   ...
   private void bindRpter()
    ...
    protected void btnadd_Click(object sender, EventArgs e)
    {
        ...
        using (SqlConnection con = new SqlConnection(CS))
        {
            SqlCommand cmd = new SqlCommand("procInsertData", con);
            ...
            if (im1.HasFile)
            {
                string savePath = Server.MapPath("~Images/DataImages/") + DID;
                ...
                SqlCommand cmd2 = new SqlCommand("insert into imageT values ('"+DID+"', '"+nam.Text.ToString().Trim() + "01"+"','"+extension+"')",con);
            ...
            if (im2.HasFile)
            {
                ...
                SqlCommand cmd3 = new SqlCommand("insert into imageT values ('" + DID + "', '" + nam.Text.ToString().Trim() + "02" + "','" + extension + "')", con);
