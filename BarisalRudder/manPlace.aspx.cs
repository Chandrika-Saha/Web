...
public partial class manPlace : System.Web.UI.Page
{
    ...
    protected void btnadd_Click(object sender, EventArgs e)
    {
        ...
        using (SqlConnection con = new SqlConnection(CS))
        {
            SqlCommand cmd = new SqlCommand("procInsertDataPl", con);
            ...
            if (im1.HasFile)
            {
                string savePath = Server.MapPath("~Images/DataPlace/") + DID;
                ...
                SqlCommand cmd2 = new SqlCommand("insert into imagePl values ('" + DID + "', '" + nam.Text.ToString().Trim() + "01" + "','" + extension + "')", con);
            ...
            if (im2.HasFile)
            {
                ...
                SqlCommand cmd3 = new SqlCommand("insert into imagePl values ('" + DID + "', '" + nam.Text.ToString().Trim() + "02" + "','" + extension + "')", con);
