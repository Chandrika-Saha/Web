        ...
        <div class="form-horizontal">
            ...
            <div class="form-group">
                    ...
                    <div class="col-md-3">
                      ...
                      <!----  <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="name is Required...!!" CssClass="text-danger" ControlToValidate="nam"></asp:RequiredFieldValidator>--->
                    </div>
             </div>
            <div class="form-group">
